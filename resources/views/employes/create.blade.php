    ...
    <x-membres-card>
        ...
        <form action="{{ route('employes.store') }}" method="post">
            ...
            <div>
                ...
                <x-text-input  id="poste" class="block mt-1 w-full" type="text" name="poste" :value="old('poste')" required autofocus />
            ...
            <div>
                ...
                <x-text-input  id="salaire" class="block mt-1 w-full" type="number" name="salaire" :value="old('salaire')" required autofocus />
            ...
            <div>
                ...
                <x-text-input  id="date_embauche" class="block mt-1 w-full" type="date" name="date_embauche" :value="old('date_embauche')" required autofocus />
